...
def seed_dual_relation_ncdm(apps, schema_editor):
    ...
    for name, description, order in DATASET_ROWS:
...
def unseed_dual_relation_ncdm(apps, schema_editor):
    pass
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("learning", "0026_auto_20260511_2110"),
    ]

    operations = [
        migrations.RunPython(seed_dual_relation_ncdm, unseed_dual_relation_ncdm),
    ]
