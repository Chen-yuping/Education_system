...
#老师功能
    ...
    path('teacher/api/knowledge-points/<int:subject_id>/relationships/ai-optimize/', views_teacherknowledge_management.ai_optimize_knowledge_relationships, name='ai_optimize_knowledge_relationships'),
    path('teacher/api/knowledge-points/<int:subject_id>/relationships/ai-apply/', views_teacherknowledge_management.apply_ai_knowledge_relationship_review, name='apply_ai_knowledge_relationship_review'),
    path('teacher/api/knowledge-points/<int:subject_id>/relationships/ai-check/', views_teacherknowledge_management.ai_check_knowledge_relationships, name='ai_check_knowledge_relationships'),
